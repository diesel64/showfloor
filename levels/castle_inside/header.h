...
extern const Gfx castle_inside_main_dl_mesh[];
extern const Gfx castle_inside_decal_dl_mesh[];
extern const Gfx castle_inside_bowser_dl_mesh[];
extern const Gfx castle_inside_bowser_painting_dl_mesh[];
extern const Gfx castle_inside_mountain_dl_mesh[];
extern const Gfx castle_inside_fire_bubble_dl_mesh[];
extern const Gfx castle_inside_fire_bubble_decal_dl_mesh[];
extern const Gfx castle_inside_water_land_dl_mesh[];
extern const Gfx castle_inside_snow_slider_dl_mesh[];
extern const Gfx castle_inside_hallway_dl_mesh[];
